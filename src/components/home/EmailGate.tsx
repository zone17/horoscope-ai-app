        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg bg-white/5 border border-white/10 pl-10 pr-3 py-2.5 text-base text-white placeholder-white/30 focus:outline-none focus:border-indigo-400/50 transition-colors font-light"
            />
          </div>
          <button
            type="submit"
