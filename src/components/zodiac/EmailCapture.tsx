    ...
    <div className="mt-8 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md p-5">
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          className="flex-1 rounded-lg bg-white/5 border border-white/10 px-3 py-2 text-base text-white placeholder-white/30 focus:outline-none focus:border-indigo-400/50 transition-colors font-light"
        />
        <button
          type="submit"
