...
/**
 * Valid author names for quote attribution validation.
 * Includes spelling variants and full names that the AI model might produce.
 * Used by reading:generate to verify quote attribution.
 */
